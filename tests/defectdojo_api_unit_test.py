...
class TestDefectDojoAPI(unittest.TestCase):
    ...
    def test_07_create_engagement(self):
        ...
        user_id = 1
        engagement = self.dd.create_engagement(
            "API Engagement",
            product_id,
            user_id,
            "In Progress",
    ...
    def test_10_set_engagement(self):
        ...
        self.dd.set_engagement(
            new_engagement_id, name="Engagement Update Test"
        )
    ...
    def test_11_create_test(self):
        ...
        test = self.dd.create_test(
            engagement_id, test_type, environment, "2016-11-01", "2016-12-01"
        )
    ...
    def test_15_create_finding(self):
        ...
        user_id = 1
        finding = self.dd.create_finding(
            "API Created",
            "Description",
            "Critical",
            cwe,
    ...
    def test_18_set_finding(self):
        self.dd.set_finding(
            self.__class__.finding_id,
            self.__class__.product_id,
            self.__class__.engagement_id,
            test_id,
            title="API Finding Updates",
        )
    ...
    def test_19_upload_scan(self):
        ...
        upload_scan = self.dd.upload_scan(
            self.__class__.engagement_id,
            "Burp Scan",
            dir_path + "/scans/Bodgeit-burp.xml",
            "true",
            date.strftime("%Y/%m/%d"),
            "API",
        )
